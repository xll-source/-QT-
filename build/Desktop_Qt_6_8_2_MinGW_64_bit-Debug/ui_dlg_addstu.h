...
public:
    ...
    void setupUi(QDialog *Dlg_AddStu)
    {
        ...
        horizontalSpacer = new QSpacerItem(95, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
    ...
    {
        Dlg_AddStu->setWindowTitle(QCoreApplication::translate("Dlg_AddStu", "Dialog", nullptr));
